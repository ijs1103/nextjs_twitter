...
function TweetForm({onCreateTweet}: TweetFormProps) {
	const { register, handleSubmit, getValues, setValue, reset, formState: { errors, isValid } } = useForm<textareaForm>({mode: "onChange"});
			...
			<div className="flex">
				<div className="flex-shrink-0 m-2 w-10 py-1">
					<img className="inline-block h-10 w-10 rounded-full"
						src="http://placeimg.com/40/40/any" alt="profile" />
				</div>
