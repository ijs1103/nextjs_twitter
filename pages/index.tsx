...
export default () => {
  ...
  return (
    <main className="relative flex flex-col lg:flex-row">
      <section className="bg-blue-500 w-full h-[50vh] lg:h-[100vh] order-2 lg:order-none flex items-center justify-center">
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          fill="#fff"
      ...
      <section className="flex flex-col justify-center items-center bg-black w-full lg:min-w-[800px] h-[100vh] order-1 px-3 py-3 lg:px-4 lg:py-4 ">
        <svg
          viewBox="0 0 24 24"
          aria-hidden="true"
          fill="#fff"
